...
int main () {
    ...
    //Inicia as perguntas imprimindo intruções na tela do usuário
    ...
    //Lê e armazena as informações que o usuário insere.
    scanf(" %c", &estado1);
    //O "espaço em branco" antes do especificador de formato serve para limpar a quebra de linha "\n".

    printf("Digite o código da carta. A letra do estado seguida de um número de 01 a 04 (ex: A01, B03):\n");
    scanf(" %s", &codigo1);
    getchar(); //Serve para limpar o buffer de entrada, remove a quebra de linha "\n".

    printf("Qual é o nome da cidade? \n");
    fgets(cidade1, 30, stdin); //Lê espaços em nomes compostos.
    ...
    //Escreve na tela do usuário as informações fornecidas ao longo do questionário.
